...
import me.seungjae.blog.config.jwt.JwtFactory;
import me.seungjae.blog.config.jwt.JwtProperties;
...
//                .build());
        ...
        User testUser = userRepository.findByEmail("user@gmail.com")
